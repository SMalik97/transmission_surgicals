...
class _CreateQuotationState extends State<CreateQuotation> {
  ...
  Widget editableGenerateQuotation(){
    if(getX.Get.parameters['purpose'] == "create"){
      ...
      quotation_no_controller.text="KOL/TS-"+selectedQuotationNo;
    ...
    pdf_widget.add(
        pw.Padding(
          ...
          child: pw.Table.fromTextArray(
              data: [
                ['Sl. No.','Product Name', 'Rate', 'Qty', 'GST','Amount'],
          ...
          child: pw.Row(
            ...
            children: [
              pw.Container(
                  ...
                  child: pw.Text("Total : "+amountToWords(int.parse(double.parse(total_amount).round().toString())), style: pw.TextStyle(fontSize: 10, fontWeight: pw.FontWeight.normal, color: PdfColors.grey900),)
              ),
            ],
          ),
        )
      ...
      pw.MultiPage(
          ...
          footer: (context)=> pw.Column(
              children: [
                ...
                pw.Text("This quotation is generated by Transmission Surgicals, for any concern contact at  surgicalstrans@gmail.com\nwww.transmissionsurgicals.com",style: pw.TextStyle(fontWeight: pw.FontWeight.normal,fontSize: 8,color: PdfColors.black),textAlign: pw.TextAlign.center),
                    ...
                    child: Row(
                      ...
                      children: [
                        Container(
                            padding: EdgeInsets.symmetric(horizontal: 20, vertical: 5),
                            color: Colors.grey.shade300,
                            child: Text("Total: "+amountToWords(int.parse(double.parse(total_amount).round().toString())), style: TextStyle(fontSize: 11, fontWeight: FontWeight.w600, color: Colors.black),)
                        ),
                      ],
                    ),
                  ),
                      ...
                      Row(
                        ...
                        children: [
                          ...
                          Column(
                            crossAxisAlignment: CrossAxisAlignment.center,
                            children: [
                              Text("Transmission Surgicals", style: TextStyle(fontWeight: FontWeight.bold, fontSize: 24, color: Colors.teal),),
                                                        ...
                                                        showDialog(context: context, builder: (BuildContext context) => image_dialog).then((value) async {
                                                          if(value != null){
                                                            ...
                                                            setState((){
                                                              ...
                                                              image_quotation_editable_list[index].product_name_controller!.text = value[2];
                                                              image_quotation_editable_list[index].product_name = value[2];
                                                            });
                                                          }
                                                        });
                                                      },
  ...
  generateImagePdf(String quotation_title, String buyer_details, String quotation_no, String quotation_date, String buyer_gst_no, List<ImageQuotationNotEditableModel> pdf_data_list, String delivery_fee, String subtotal, String gst, String total_amount, String terms) async {
    ...
    pdf_widget.add(pw.SizedBox(height: 3,),);
    ...
    pdf_widget.add(
      pw.Row(
          mainAxisAlignment: pw.MainAxisAlignment.center,
          children: [
            pw.Text(quotation_title,style: pw.TextStyle(fontWeight: pw.FontWeight.bold,fontSize: 11,color: PdfColors.black ))
          ]
      ),
    );
    pdf_widget.add(
                  ...
                  children: [
                    pw.Expanded(
                      child: pw.Container(
                        ...
                        child: pw.Column(
                          ...
                          mainAxisAlignment: pw.MainAxisAlignment.start,
                          children: [
                            pw.Text("TO : ", style: pw.TextStyle(color: PdfColors.black,fontSize: 12, fontWeight: pw.FontWeight.bold),),
                            pw.SizedBox(height: 2,),
                            pw.Expanded(
                              child: pw.Text(
                                  buyer_details,
                    ...
                    pw.Container(
                      ...
                      child: pw.Row(
                        ...
                        children: [
                          pw.Text("Customer GST : ", style: pw.TextStyle(color: PdfColors.black,fontSize: 9, fontWeight: pw.FontWeight.bold),),
                          pw.Expanded(
                            child: pw.Text(
                                buyer_gst_no,
                                style: pw.TextStyle(color: PdfColors.black,fontSize: 10, fontWeight: pw.FontWeight.normal)
                            ...
                            pw.Container(
                                ...
                                child: pw.Column(
                                  ...
                                  children: [
                                    pw.Padding(
                                      padding: pw.EdgeInsets.symmetric(vertical: 5, horizontal: 5),
                                      child: pw.Image(pw.MemoryImage(item.value.ImageData!)),
                                    )
                                  ]
                                )
                            ),
                ...
                pw.Row(
                  ...
                  children: [
                    ...
                    pw.Column(
                      crossAxisAlignment: pw.CrossAxisAlignment.center,
                      children: [
                        pw.Text("Transmission Surgicals", style: pw.TextStyle(fontWeight: pw.FontWeight.bold, fontSize: 14, color: PdfColors.teal),),
  ...
  createImageQuotation(String quotation_title,String buyer_details, String buyer_gst, String date, String delivery_fee, String subtotal, String gst, String total_amount, List<ImageQuotationNotEditableModel> quotation_item_list, String terms) async {
    ...
    var url = Uri.parse(create_image_quotation);
    Map<String, String> body = {"quotation_title":quotation_title,"buyer_details": buyer_details, "buyer_gst":buyer_gst, "date":date, "quotations_details":item_list, "delivery_fee":delivery_fee, "subtotal":subtotal, "gst":gst, "total_amount":total_amount, "terms":terms};
    Response response = await post(url, body: body);
    if (response.statusCode == 200) {
      String myData = response.body;
      ...
      if (jsonData['status'] == "success") {
        ...
        generateImagePdf(quotation_title, buyer_details, selectedQuotationNo,  DateFormat('dd/MM/yyyy').format(DateTime.now()), buyer_gst, quotation_item_list, delivery_fee, subtotal, gst, total_amount, terms);
                                  ...
                                  children: [
                                    ...
                                    TableCell(
                                      ...
                                      child: SizedBox(
                                        ...
                                        child: Padding(
                                          padding: EdgeInsets.symmetric(horizontal: 5, vertical: 3),
                                          child: Text(quotation_item_list[index].productName.toString(),style: TextStyle(fontWeight: FontWeight.w500, fontSize: 14,), maxLines: null,overflow: TextOverflow.fade,
                                          ),
                                        ),
                                      ),
                                    ),
                                    ...
                                    TableCell(
                                      ...
                                      child: SizedBox(
                                        ...
                                        child: Padding(
                                            padding: EdgeInsets.symmetric(horizontal: 5, vertical: 3),
                                            child: Image.memory(quotation_item_list[index].ImageData!,)
                                        ),
                                      ),
                                    ),
                                    ...
                                    TableCell(
                                      ...
                                      child: SizedBox(
                                        ...
                                        child: Padding(
                                          padding: EdgeInsets.symmetric(horizontal: 5, vertical: 3),
                                          child: Text(quotation_item_list[index].quantity.toString(),style: TextStyle(fontWeight: FontWeight.w500, fontSize: 14,),maxLines: null,
                                          ),
                                        ),
                                      ),
                                    ),
                                        ...
                                        child: Padding(
                                          ...
                                          child: Column(
                                            children: [
                                              SizedBox(
                                                height: 25,
                                                  child: Text(quotation_item_list[index].gst.toString(),style: TextStyle(fontWeight: FontWeight.w500, fontSize: 14,),)
                                              ),
                                              Expanded(
                                                child: Text(quotation_item_list[index].gst_percentage.toString(),style: TextStyle(fontWeight: FontWeight.w500, fontSize: 11,),
                                                ),
