...
class _CreateQuotationState extends State<CreateQuotation> {
  ...
  int selectedTab=1;
  String selectedQuotationId="", quotation_no="", purpose="",selectedQuotationBuyerName="", selectedQuotationBuyerAddress="", selectedQuotationBuyerContactDetails="", selectedQuotationBuyerGst="";
                                      ...
                                      children: [
                                                            ...
                                                            builder: (context, setState) {
                                                              return Container(
                                                                ...
                                                                child: Column(
                                                                  crossAxisAlignment: CrossAxisAlignment.start,
                                                                  children: [
                                                                    Text('Images',style: TextStyle(fontWeight: FontWeight.bold,fontSize: 15,color: Colors.black),),
                                                                    SizedBox(height: 10),
                                                                    TextField(
                                                                                ...
                                                                                child: Column(
                                                                                  children: [
                                                                                    Expanded(
                                                                                      child: InkWell(
                                                                                        onTap: (){
                                                                                          getX.Get.back(result: [ product_image_base_path+product_image[index].imageName.toString(),  product_image_base_path+product_image[index].productId.toString(),]);
                                                                                        },
                                                                                        child: Container(
                                                                                          width: double.infinity,
                                                                                          decoration: BoxDecoration(
                                        ...
                                        TableCell(
                                          ...
                                          child: SizedBox(
                                            ...
                                            child: Padding(
                                              ...
                                              child: Column(
                                                children: [
                                                  Expanded(child: Text(image_quotation_editable_list[index].gst.toString(),style: TextStyle(fontWeight: FontWeight.w500, fontSize: 14,),)),
                                                  Expanded(
                                                    child: TextField(
                                        ...
                                        TableCell(
                                          ...
                                          child: SizedBox(
                                            ...
                                            child: Center(
                                              child: Text(
                                                image_quotation_editable_list[index].amount.toString(),
                                                maxLines: 1,
  ...
  generateImagePdf(String quotation_id,String quotation_title, String buyer_name, String buyer_address, String buyer_contact_details, String quotation_no, String quotation_date, String buyer_gst_no, String seller_contact_details, List<ImageQuotationNotEditableModel> pdf_data_list, String packaging_fee, String subtotal, String gst, String total_amount,) async {
    ...
    final anchor = html.document.createElement('a') as html.AnchorElement
      ..href = url
      ..download = "Quotation"+selectedQuotationId+'.pdf';
    html.document.body?.children.add(anchor);
    anchor.click();
    html.document.body?.children.remove(anchor);
    html.Url.revokeObjectUrl(url);
